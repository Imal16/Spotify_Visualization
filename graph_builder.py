...
def build_graph(user_data = False):
    ...
    if user_data:
        ...
        for items in user_top['items']:
            ...
            artist_graph[items['name']] = {'related': [], 'id': items['id'], 'genre': artist_genre,
                                           ...
                                           'followers': items['followers']['total'],'Top' : True}

    else:
        
        top_ids = ['5K4W6rqBFWDnAN6FQUkS6x', '3TVXtAsR1Inumwj472S9r4', '2SrSdSvpminqmStGELCSNd', '6nxWCVXbOlEVRexSbLsTer', '60d24wfXkVzDSfLS6hyCjZ', '6Ip8FS7vWT1uKkJSweANQK', '50JJSqHUf2RQ9xsHs0KMHg', '02kJSzxNuaWGqwubyUba0Z', '1Bl6wpkWCQ4KVgnASpvzzA', '3hOdow4ZPmrby7Q1wfPLEy', '3ApUX1o6oSz321MMECyIYd', '0JuDxOwz1e3Wx05t8e3AT3', '2cFrymmkijnjDg9SS92EPM', '6l3HvQ5sa6mXTsMTB19rO5', '1vCWHaC5f2uS3yhpwWbIA6', '0c173mlxpT3dSFRgMO8XPh', '246dkjvS1zLTtiykXe5h60', '5f7VJjfbwm532GiveGC0ZK', '4Xi6LSfFqv26XgP9NKN26U', '0EeQBlQJFiAfJeVN2vT9s0', '4Dokdwa3WB7ilQ2c2qvIBL', '3nFkdlSjzX9mRTtwJOzDYB', '4e7DLHD3L0VvT1ubv5oq0w', '2qxJFvFYMEDqd7ui6kSAcq', '2ZeAzgQtLfcPmMap31S0dZ', '6USv9qhCn6zfxlBQIYJ9qs', '20sxb77xiYeusSH8cVdatc', '3gIRvgZssIb9aiirIg0nI3', '5Matrg5du62bXwer29cU5T', '0huGjMyP507tBCARyzSkrv', '1gPhS1zisyXr5dHTYZyiMe', '0Y5tJX1MQlPlqiwlOH1tJY', '7fqDRFkiuwzFDde1K0taVs', '2P5sC9cVZDToPxyomzF1UH', '6eUKZXaKkcviH0Ku9w2n3V', '15UsOTVnJzReFVN1VCnxy4', '0gusqTJKxtU1UTmNRMHZcv', '5zctI4wO9XSKS8XwcnqEHk', '3IYUhFvPQItj6xySrBmZkd', '3eqjTLE0HfPfh78zjh6TqT', '4IZLJdhHCqAvT4pjn8TLH5', '67ea9eGLXYMsO2eYQRui3w', '2jku7tDXc6XoB6MO2hFuqg', '7FqkRutc4zWMrnEAUv3Xwd', '039zhJoEkboZ8Ii6K40Fb6']
        ...
        for related_artist in related['artists']:
            ...
            if related_artist['name'] in artist_graph:
                ...
                artist_graph[related_artist['name']] = {'related': [i], 'id': related_artist['id'],
                                    ...
                                    'followers': related_artist['followers']['total'], 'Top': False}
                    
    return artist_graph


def visualize_graph(graph):
    Artist_Network = Network()
